            ...
            return (
              <Card key={plan.id} className="flex flex-col h-full p-6"> {/* Card usa bg-card-bg */}
                <div className="text-center">
                  ...
                  <p className="text-4xl font-extrabold text-headings mb-1">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <Card className="p-6">
              ...
              <p className="text-3xl font-extrabold text-headings mb-4">R${PRICING_INFO.addOns.liveFeedback.price.toFixed(2)}</p>
            ...
            <Card className="p-6">
              ...
              <p className="text-3xl font-extrabold text-headings mb-4">R${PRICING_INFO.addOns.oneOnOneSession.price.toFixed(2)}</p>
