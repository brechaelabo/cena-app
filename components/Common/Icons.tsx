...
export const FilmIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => ( 
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m3.75-3.75v3.75m-7.5-3.75V6.75A2.25 2.25 0 015.25 4.5h13.5A2.25 2.25 0 0121 6.75v9.75M6 20.25v-3.75m0 0v-3.75m0 0H3.75m7.5 0H11.25m2.25 0h2.25m3.75 0H18.75m-1.5-3.75h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V18m-2.25-3.75h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V18m-2.25-3.75h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V18M3.75 6.75h.008v.008H3.75V6.75zm0 2.25h.008v.008H3.75v-.008zm0 2.25h.008v.008H3.75V11.25m15-4.5h.008v.008H18.75V6.75zm0 2.25h.008v.008H18.75v-.008zm0 2.25h.008v.008H18.75V11.25m-3.75-4.5h.008v.008H15V6.75zm0 2.25h.008v.008H15v-.008zm0 2.25h.008v.008H15V11.25m-3.75-4.5h.008v.008h-.008V6.75zm0 2.25h.008v.008h-.008v-.008zm0 2.25h.008v.008h-.008V11.25" />
  </svg>
);
...
export const PriceTagIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className}>
...
export const AcademicCapIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 0 0-.491 6.347A48.627 48.627 0 0 1 12 20.904a48.627 48.627 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.57 50.57 0 0 0-2.658-.813A59.905 59.905 0 0 1 12 3.493a59.905 59.905 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
  </svg>
);
...
export const PaperAirplaneIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className} transform="rotate(-45 12 12)">
...
export const SessoesIcon = UserGroupIcon; // Alias for semantic clarity

export const ShareIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.19.025.383.042.577.052a2.25 2.25 0 014.242 0M11.25 12a2.25 2.25 0 00-4.135 1.093M12.375 10.907a2.25 2.25 0 00-4.135-1.093m0 0c.577 0 1.155.024 1.732.071m6.083-1.094a2.25 2.25 0 100-2.186m0 2.186c-.19.025-.383.042-.577.052a2.25 2.25 0 01-4.242 0M13.5 12a2.25 2.25 0 004.135-1.093m-4.135 1.093c-.577 0-1.155.024-1.732.071" />
  </svg>
);

export const GlobeAltIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 017.843 4.582M12 3a8.997 8.997 0 00-7.843 4.582m15.686 0A11.953 11.953 0 0112 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253m0 0A11.978 11.978 0 0112 16.5c-3.001 0-5.741-1.103-7.843-2.918m15.686 0A8.959 8.959 0 0121 12c0 .778-.099 1.533-.284 2.253M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);
...
export const NetworkIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
    ...
    {/* Top-Right */}
    <circle cx="18.39" cy="7.61" r="2" />
    <line x1="13.76" y1="10.24" x2="16.61" y2="8.39" stroke="currentColor" strokeWidth="1.5" />
    {/* Bottom-Right */}
    <circle cx="18.39" cy="16.39" r="2" />
    <line x1="13.76" y1="13.76" x2="16.61" y2="15.61" stroke="currentColor" strokeWidth="1.5" />
    {/* Bottom */}
    <circle cx="12" cy="20" r="2" />
    <line x1="12" y1="14" x2="12" y2="18" stroke="currentColor" strokeWidth="1.5" />
    {/* Bottom-Left */}
    <circle cx="5.61" cy="16.39" r="2" />
    <line x1="10.24" y1="13.76" x2="7.39" y2="15.61" stroke="currentColor" strokeWidth="1.5" />
    {/* Top-Left */}
    <circle cx="5.61" cy="7.61" r="2" />
    <line x1="10.24" y1="10.24" x2="7.39" y2="8.39" stroke="currentColor" strokeWidth="1.5" />
  </svg>
);
...
export const LiveIndicatorIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
...
export const PuzzlePieceIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 7.756a4.5 4.5 0 100 8.488M7.5 10.5h5.25m-5.25 3h5.25M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 6.75h.008v.008H12v-.008zm0-3.75h.008v.008H12v-.008zm0-3.75h.008v.008H12v-.008zm0-3.75h.008v.008H12V6zm-3.75 9.75h.008v.008H8.25v-.008zm0-3.75h.008v.008H8.25v-.008zm0-3.75h.008v.008H8.25v-.008zm3.75 0h.008v.008H12V9.75zm3.75 9.75h.008v.008H15.75v-.008zm0-3.75h.008v.008H15.75v-.008zm0-3.75h.008v.008H15.75v-.008zm0-3.75h.008v.008H15.75V6zM7.5 12a1.5 1.5 0 00-1.5 1.5v.008a1.5 1.5 0 001.5 1.5h.008a1.5 1.5 0 001.5-1.5v-.008a1.5 1.5 0 00-1.5-1.5H7.5z"/>
  </svg>
);
...
export const ArchiveBoxIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75h16.5a.75.75 0 01.75.75v11.25a.75.75 0 01-.75.75H3.75a.75.75 0 01-.75-.75V10.5a.75.75 0 01.75-.75zm16.5 0V6.75A2.25 2.25 0 0018 4.5h-3.75m-3.75 0H6A2.25 2.25 0 003.75 6.75v3" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75h.008v.008H12v-.008z" />
  </svg>
);

export const InboxArrowDownIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
